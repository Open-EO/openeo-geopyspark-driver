...
def main():
    ...
    for url in [
        ...
        # TODO: Change back to standard geotrellis-extensions-2.3.0_2.12-SNAPSHOT.jar
        "https://artifactory.vgt.vito.be:443/testdata-public/shub-128/geotrellis-extensions-2.3.0_2.12-SNAPSHOT.jar",
