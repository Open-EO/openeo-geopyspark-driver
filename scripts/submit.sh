...
spark-submit --principal mep_tsviewer@VGT.VITO.BE --keytab mep_tsviewer.keytab --driver-memory 8G --executor-memory 5G --queue mep_tsviewer \
 ...
 --files layercatalog.json,geotrellis-extensions-1.0.0-20181009.080938-2.jar,dependencies/geopyspark/jars/geotrellis-backend-assembly-0.4.0.jar --conf spark.hadoop.security.authentication=kerberos --conf spark.yarn.maxAppAttempts=1 \
