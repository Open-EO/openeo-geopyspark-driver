...
def main():
    ...
    for url in [
        ...
        "https://artifactory.vgt.vito.be/artifactory/libs-release-public/org/openeo/geotrellis-extensions/PR-410/geotrellis-extensions-PR-410.jar",
        "https://artifactory.vgt.vito.be/artifactory/libs-release-public/org/openeo/openeo-logging/PR-410/openeo-logging-PR-410.jar",
    ]:
