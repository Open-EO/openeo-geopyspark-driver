...
def test_function_supports_kwargs():
    ...
    assert _function_supports_kwargs(fun1) is False
    assert _function_supports_kwargs(fun2) is True
    assert _function_supports_kwargs(fun3) is True

    assert _function_supports_kwargs(lambda: 2) is False
    assert _function_supports_kwargs(lambda x: x) is False
    assert _function_supports_kwargs(lambda kwargs: 3) is False
    assert _function_supports_kwargs(lambda **k: k) is True
