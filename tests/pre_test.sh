...
if [ $(lsb_release -rs) = "8.2.2004" ]; then
  curl -L -O -C - https://artifactory.vgt.vito.be/libs-snapshot-public/org/openeo/geotrellis-extensions/2.2.0_2.12-SNAPSHOT/geotrellis-extensions-2.2.0_2.12-SNAPSHOT.jar
