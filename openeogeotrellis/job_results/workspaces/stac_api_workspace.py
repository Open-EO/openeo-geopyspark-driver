...
class StacApiWorkspace(Workspace):
    ...
    def __init__(
        ...
        *,
        resilient_stac_io_class: Type[DefaultStacIO],
        logging_stac_api_io_class: Type[StacApiIO],
        ...
        :param resilient_stac_io_class: a `DefaultStacIO` subclass that reads with timeout and retry
        :param logging_stac_api_io_class: a `StacApiIO` subclass that logs every HTTP request
        """
        ...
        self._resilient_stac_io_class = resilient_stac_io_class
        self._logging_stac_api_io_class = logging_stac_api_io_class
    ...
    def merge(self, stac_resource: STACObject, target: PurePath, remove_original: bool = False) -> STACObject:
        ...
        if isinstance(stac_resource, Collection):
            ...
            with requests_with_retry(
                ...
                try:
                    stac_io = self._resilient_stac_io_class(session=session)
    ...
    def _assert_catalog_supports_necessary_api(self):
        ...
        stac_io = self._logging_stac_api_io_class(timeout=self.REQUESTS_TIMEOUT_SECONDS, max_retries=retry)
